  ...
  <div class="row">
    <div class="col-md-2 mt-2 pr-3 pt-4 bg-secondary">
      ...
      <ul class="nav flex-column">
        ...
        <li class=" nav-item">
          <a class="nav-link text-white" href="#"><i class="fas fa-calendar-day"></i> Jadwal Kuliah</a>
          <hr>
        </li>
    ...
    <div class=" col-md-10 pd-5 pt-4">
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item">
          <a href="tambah.php?id=<?= $cmb['id']; ?>" class="btn btn-warning role=" button">Edit</a>
          <a href="delete.php?id=<?= $cmb['id']; ?>" class="btn btn-danger role=" button">Hapus</a>
