...
<body id="page-top">
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      <h3><i class=""></i>Input Data Barang Baru</h3>
      <!-- Icon Divider-->
      ...
      <form method="post" action="">
        ...
        <<div class="form-group">
          ...
          <input type="text" class="form-control" id="stock" name="stock" required autocomplete="off">
    </div>
    <div class="form-group">
    ...
    <button type="submit" class="btn btn-outline-light" name="submit">Input Data</button>
    </form>
